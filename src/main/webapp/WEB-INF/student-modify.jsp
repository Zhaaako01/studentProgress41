...
<section class="std-modifying-sec">
    <h2 class="std-mdf-h2">Для модификации, введите новые значения и нажмите кнопку "Применить".</h2>

    <form action="/student-modify" method="post" class="std-mod-form">

        <input type="hidden" name="idStudToModify" value="${studentById.id}">

        <label for="last-name">Фамилия:</label>
        <input type="text" id="last-name" name="last-name" value="${studentById.surname}"><br><br>

        <label for="first-name">Имя:</label>
        <input type="text" id="first-name" name="first-name" value="${studentById.name}"><br><br>
